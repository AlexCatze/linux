/*
 * include/asm/arm/arch-pxa/g900-init.h
 */

#ifndef _G900_INIT_H_
#define _G900_INIT_H_

/* G900 initialization data should be found here
...
#define GPIO98_Dir	1
#define GPIO99_Dir	0
#define GPIO100_Dir	0
#define GPIO101_Dir	0
#define GPIO102_Dir	0
#define GPIO103_Dir	0
#define GPIO104_Dir	1
#define GPIO105_Dir	1
#define GPIO106_Dir	1
#define GPIO107_Dir	1
#define GPIO108_Dir	1
#define GPIO109_Dir	1
#define GPIO110_Dir	1
#define GPIO111_Dir	1
#define GPIO112_Dir	1
#define GPIO113_Dir	1
#define GPIO114_Dir	0
#define GPIO115_Dir	0
#define GPIO116_Dir	0
#define GPIO117_Dir	1
#define GPIO118_Dir	1
#define GPIO119_Dir	0
...
#define GPIO52_AltFunc  1
#define GPIO53_AltFunc  2
#define GPIO54_AltFunc  3
...
#define GPIO78_AltFunc  1
#define GPIO79_AltFunc  2
#define GPIO80_AltFunc  0
#define GPIO81_AltFunc	2
#define GPIO82_AltFunc	3
#define GPIO83_AltFunc	0
#define GPIO84_AltFunc	3
#define GPIO85_AltFunc	3
#define GPIO86_AltFunc	0
#define GPIO87_AltFunc	0
#define GPIO88_AltFunc	0
#define GPIO89_AltFunc	2
#define GPIO90_AltFunc	0
#define GPIO91_AltFunc	0
#define GPIO92_AltFunc	1
#define GPIO93_AltFunc	2
#define GPIO94_AltFunc	1
#define GPIO95_AltFunc	1
#define GPIO96_AltFunc	0
#define GPIO97_AltFunc	0
#define GPIO98_AltFunc	1
#define GPIO99_AltFunc	1
#define GPIO100_AltFunc 1
#define GPIO101_AltFunc 1
#define GPIO102_AltFunc 1
#define GPIO103_AltFunc 2
#define GPIO104_AltFunc 2
#define GPIO105_AltFunc 2
#define GPIO106_AltFunc 2
#define GPIO107_AltFunc 2
#define GPIO108_AltFunc 2
#define GPIO109_AltFunc 1
#define GPIO110_AltFunc 1
#define GPIO111_AltFunc 1
#define GPIO112_AltFunc 1
#define GPIO113_AltFunc 0
#define GPIO114_AltFunc 1
#define GPIO115_AltFunc 2
#define GPIO116_AltFunc 1
#define GPIO117_AltFunc 1
#define GPIO118_AltFunc 1
#define GPIO119_AltFunc 0

/* GPIO Pin Init State */
#define GPIO00_Level    1//0
#define GPIO01_Level    1//0
#define GPIO02_Level    1
#define GPIO03_Level    1
#define GPIO04_Level    1
...
#define GPIO72_Level    0
#define GPIO73_Level    0
...
#define GPIO80_Level    0
#define GPIO81_Level	1
#define GPIO82_Level	1
#define GPIO83_Level	0 //?
#define GPIO84_Level	1
#define GPIO85_Level	1
#define GPIO86_Level	1
#define GPIO87_Level	1
#define GPIO88_Level	1
#define GPIO89_Level    0
#define GPIO90_Level	0
#define GPIO91_Level	0
#define GPIO92_Level	0
#define GPIO93_Level	0
#define GPIO94_Level	0
#define GPIO95_Level	0
...
#define GPIO81_Sleep_Level      0
#define GPIO82_Sleep_Level      0
#define GPIO83_Sleep_Level      0
#define GPIO84_Sleep_Level      0
#define GPIO85_Sleep_Level      0
#define GPIO86_Sleep_Level      0
#define GPIO87_Sleep_Level      0
#define GPIO88_Sleep_Level      1
#define GPIO89_Sleep_Level      0
#define GPIO90_Sleep_Level      0
#define GPIO91_Sleep_Level      0
#define GPIO92_Sleep_Level      0
#define GPIO93_Sleep_Level      0
#define GPIO94_Sleep_Level      0
#define GPIO95_Sleep_Level      0
//
#define GPIO96_Sleep_Level      0
#define GPIO97_Sleep_Level      0
#define GPIO98_Sleep_Level      0
#define GPIO99_Sleep_Level      0
#define GPIO100_Sleep_Level      0
#define GPIO101_Sleep_Level      1
#define GPIO102_Sleep_Level      0
#define GPIO103_Sleep_Level      0
#define GPIO104_Sleep_Level      0
#define GPIO105_Sleep_Level      0
#define GPIO106_Sleep_Level      1
#define GPIO107_Sleep_Level      0
#define GPIO108_Sleep_Level      1
#define GPIO109_Sleep_Level      1
#define GPIO110_Sleep_Level      1
#define GPIO111_Sleep_Level      1
#define GPIO112_Sleep_Level      1
#define GPIO113_Sleep_Level      1
#define GPIO114_Sleep_Level      1
#define GPIO115_Sleep_Level      1
#define GPIO116_Sleep_Level      1
#define GPIO117_Sleep_Level      1
#define GPIO118_Sleep_Level      1
#define GPIO119_Sleep_Level      1
...
#define GAFR1z_i0		(GPIO80_AltFunc << 0) + (GPIO81_AltFunc << 2) + (GPIO82_AltFunc << 4) + (GPIO83_AltFunc << 6)
#define GAFR1z_i1		(GPIO84_AltFunc << 8) + (GPIO85_AltFunc << 10) + (GPIO86_AltFunc << 12) + (GPIO87_AltFunc << 14)
#define GAFR1z_i2		(GPIO88_AltFunc << 16) + (GPIO89_AltFunc << 18) + (GPIO90_AltFunc << 20) + (GPIO91_AltFunc << 22)
#define GAFR1z_i3		(GPIO92_AltFunc << 24) + (GPIO93_AltFunc << 26) + (GPIO94_AltFunc << 28) + (GPIO95_AltFunc << 30)
#define GAFR1z_InitValue	(GAFR1z_i0 + GAFR1z_i1 + GAFR1z_i2 + GAFR1z_i3)
...
#define GPSRz_i4		(GPIO80_Level << 16) + (GPIO81_Level << 17) + (GPIO82_Level << 18) + (GPIO83_Level << 19)
#define GPSRz_i5		(GPIO84_Level << 20) + (GPIO85_Level << 21) + (GPIO86_Level << 22) + (GPIO87_Level << 23)
#define GPSRz_i6		(GPIO88_Level << 24) + (GPIO88_Level << 25) + (GPIO90_Level << 26) + (GPIO91_Level << 27)
#define GPSRz_i7		(GPIO92_Level << 28) + (GPIO93_Level << 29) + (GPIO94_Level << 30) + (GPIO95_Level << 31)
#define GPSRz_InitValue		(GPSRz_i0 + GPSRz_i1 + GPSRz_i2 + GPSRz_i3 + GPSRz_i4 + GPSRz_i5 + GPSRz_i6 + GPSRz_i7)
...
#define GPSRz_si4		(GPIO80_Sleep_Level << 16) + (GPIO81_Sleep_Level << 17) + (GPIO82_Sleep_Level << 18) + (GPIO83_Sleep_Level << 19)
#define GPSRz_si5		(GPIO84_Sleep_Level << 20) + (GPIO85_Sleep_Level << 21) + (GPIO86_Sleep_Level << 22) + (GPIO87_Sleep_Level << 23)
#define GPSRz_si6		(GPIO88_Sleep_Level << 24) + (GPIO88_Sleep_Level << 25) + (GPIO90_Sleep_Level << 26) + (GPIO91_Sleep_Level << 27)
#define GPSRz_si7		(GPIO92_Sleep_Level << 28) + (GPIO93_Sleep_Level << 29) + (GPIO94_Sleep_Level << 30) + (GPIO95_Sleep_Level << 31)
#define GPSRz_SleepValue	(GPSRz_si0 + GPSRz_si1 + GPSRz_si2 + GPSRz_si3 + GPSRz_si4 + GPSRz_si5 + GPSRz_si6 + GPSRz_si7)
